  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <VideoSubmitDialog>
          <button className="inline-flex items-center gap-2 h-10 px-5 rounded-lg bg-accent text-accent-foreground font-medium text-sm hover:bg-amber-400 transition-colors shadow-sm">
