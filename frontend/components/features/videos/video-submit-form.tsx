            ...
            <div className="space-y-2">
              <div className="relative">
                <input
                  ...
                  required
                  className="flex w-full h-12 rounded-lg border border-input bg-background pl-4 pr-10 text-sm text-foreground outline-none placeholder:text-muted-foreground transition-all focus:border-ring focus:ring-2 focus:ring-ring/20"
                />
                {url && (
